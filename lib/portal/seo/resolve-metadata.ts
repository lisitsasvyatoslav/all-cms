...
import { PORTAL_SITE_OG_RELATIVE_PATH } from "@/lib/portal/seo/default-og";
import {
  RELATED_PREVIEW_HEIGHT,
  RELATED_PREVIEW_WIDTH,
} from "@/lib/portal/documentation/related-preview-layout";
import { portalAbsoluteUrl, portalSiteOrigin } from "@/lib/portal/seo/site-url";

import type { NormalizedPortalSeo } from "./defaults";
