/** Initial Payload value. Runtime consumers always read the editable global. */
export const LAYOUT_GUIDE_MARKDOWN = `# Layout
...
Each layout component has a set of its own specialized props and also a shared set of common layout props. All layout props support [responsive object values](/themes/docs/theme/breakpoints).
