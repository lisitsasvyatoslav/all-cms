...
import { CursorMcpSetupDialog } from "@/components/portal/cursor-mcp-setup-dialog";
import {
  CheckIcon,
  CopyMarkdownIcon,
  ExternalLinkIcon,
} from "@/components/portal/page-action-icons";
import { componentWebMarkdownPath } from "@/lib/portal/component-routes";
            ...
            {menuItems.map((item) => (
              ...
              >
                <div className="portal-page-actions__menu-item-inner">
                  ...
                  <span className="portal-page-actions__menu-external" aria-hidden>
