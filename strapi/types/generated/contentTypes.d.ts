...
export interface ApiColorColor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    tokenKey: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiComponentComponent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    figmaUrl: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::component.component'
...
export interface ApiPortalSourcePortalSource extends Struct.SingleTypeSchema {
  collectionName: 'portal_sources';
  info: {
    displayName: 'Portal sources';
    pluralName: 'portal-sources';
    singularName: 'portal-source';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    figmaLibraryUrl: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::portal-source.portal-source'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::portal-source.portal-source': ApiPortalSourcePortalSource;
